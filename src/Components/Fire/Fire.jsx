    ...
    <div>
      <div className="container">
        ...
        <div>
            ...
            <div className=' 2xl:w-8/12 lg:w-5/12  lg:h-44 lg:mt-5 sm:w-64 md:w-80 bg-white w-80 h-42 ml-12 mr-5  rounded-md mt-7 p-5 '>
                ...
                <div className='2xl:w-8/12 xl:ml-16 lg:w-5/12 lg:ml-8 lg:h-44 lg:mt-5 sm:w-64 md:ml-2 md:w-80 bg-white w-80 h-42 ml-12 mr-5  rounded-md mt-7 p-5 '>
