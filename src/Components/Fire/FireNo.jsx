...
const FireNo = ({ total,year }) => {
  return (
    ...
    <div className='bg-gray-950 text-white 2xl:ml-52 2xl:mr-40 lg:mr-16 xl:mr-20 sm:w-11/12 md:w-auto md:ml-12 md:mr-12 rounded-lg sm:m-10 ml-5 w-80 mt-6  flex flex-col h-40 '>
