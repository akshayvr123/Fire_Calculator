      ...
      <div className="container">
        ...
        <div className={` flex flex-wrap`}> 
         <div className={`${data.order}    2xl:w-2/4  ${data.ml} ${data.margin} lg:w-3/5   `}>
               <h1 className={`${data.ml} 2xl:text-5xl xl:text-5xl lg:w-auto lg:text-4xl md:text-3xl mt-5 sm:mt-10  ml-12 leading-8 text-2xl font-bold tracking-tight`}>{data.Heading}</h1>
               <p className={`w-80 ${data.ml}   2xl:text-3xl xl:ml-16 xl:w-4/5 lg:w-auto lg:text-3xl md:mt-5 md:w-96 sm:w-80 md:text-2xl ml-12 mt-2 text-base font-semibold`}>{data.content}</p>
          </div>
